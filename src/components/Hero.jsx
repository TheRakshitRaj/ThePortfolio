...
const profileImg = 'https://res.cloudinary.com/dphtrtpjx/image/upload/v1788349723/IMG_20260320_223318_l13vf9.png';
...
const Hero = () => {
  ...
  const socialLinks = [
    { href: 'https://www.linkedin.com/in/rakshit-raj-817508394/', Icon: IconLinkedin, label: 'LinkedIn' },
    { href: 'https://github.com/TheRakshitRaj', Icon: IconGithub, label: 'GitHub' },
    { href: 'https://instagram.com', Icon: IconInstagram, label: 'Instagram' },
    { href: 'mailto:rakshit.raj.cg@gmail.com', Icon: IconMail, label: 'Email' },
  ];
